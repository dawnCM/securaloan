...
<html lang="en">
    <head>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-71925930-5"></script>
		<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());

		  gtag('config', 'UA-71925930-5');
		</script>
        ...
        <meta name="author" content="Securaloan.xyz">
        <title>Securaloan</title>
		            ...
		            <nav class="navbar navbar-default" role="navigation">
		              <div class="container-fluid">
		                ...
		                <div class="navbar-header">
		                  ...
		                  <a class="navbar-brand" href="#"><?php echo $this->Html->image('ws_logo.png', array('alt'=>'Winshiplending', 'class'=>'img-responsive', 'width'=>'223', 'height'=>'84', 'url'=>'/')); ?></a>
		                </div>
		                ...
		                <div class="collapse navbar-collapse" id="ws_navbar">
		                  <ul class="nav navbar-nav navbar-right">
		                    ...
		                    <li><a href="https://global.leadstudio.com/privacy?site=SecuraLoan" data-title="Privacy Policy" data-toggle="lightbox" data-gallery="remoteload"><span class="glyphicon glyphicon-eye-open"></span> Privacy</a></li>
...
Because there are many lenders offering many different products we don’t know the exact APR that a lender may offer you.  But rest assured, your lender must disclose all this information to you before you obligate yourself to any loan.  The APR on a personal loan from our network of lenders can range from 5.99% to 35.99%, with loan durations between 90 days and 72 months. The actual loan rate depends on the loan amount and term requested, as well as your credit score, usage, and history. If you are offered a loan, you will have the opportunity to review the final offer made by the lender, and to accept the loan agreement made directly between you and the lender.				
		        ...
		        <div class="row">
		        	<div class="col-sm-12 text-center" id="ws_footlinks">
						...
						<script src="https://stage.ola-memberseal.org/js/seal.js?seal=member&amp;token=xn3Un5TqndHRSbNqEcX&amp;sealwidth=100&amp;sealheight=100"></script>
					<!--Official OLA Member Seal--><br />
		...
		<script type='text/javascript'> var _at = {}; window._at.track = window._at.track || function(){(window._at.track.q = window._at.track.q || []).push(arguments);}; _at.domain = 'securaloan.xyz/';_at.owner = '4fb8663b03db';_at.idSite = '10493';_at.forceRefreshSW = 1;_at.attributes = {};_at.webpushid = 'web.65.aimtell.com';(function() { var u='//s3.amazonaws.com/cdn.aimtell.com/trackpush/'; var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0]; g.type='text/javascript'; g.async=true; g.defer=true; g.src=u+'trackpush.min.js'; s.parentNode.insertBefore(g,s); })();</script>
